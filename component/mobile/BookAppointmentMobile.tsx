...
import { Users, Shield, ChevronDown, Menu } from "lucide-react";
      ...
      <div className="bg-gray-50 px-5 py-8">
        ...
        <div className="bg-white rounded-lg p-5 shadow-sm">
          <p className="text-sm text-gray-700 leading-relaxed">
            {activeTab === "Overview" &&
              "Comprehensive overview of our urology services and treatment options. We provide world-class care with state-of-the-art facilities."}
            {activeTab === "Symptoms" &&
              "Common symptoms include frequent urination, pain during urination, blood in urine, and abdominal discomfort. Consult our experts for proper diagnosis."}
            {activeTab === "Procedure" &&
              "Our procedures are minimally invasive using the latest technology. We ensure patient comfort and quick recovery with expert medical care."}
            {activeTab === "Benefits" &&
              "Benefits include quick recovery time, minimal scarring, reduced pain, and improved quality of life. Our success rate is over 95%."}
          </p>
        </div>
      </div>
      <Footer/>
